...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; Code folding method. Possible values
   ;; are `evil', `origami' and `vimish'.
   ;; (default 'evil)
